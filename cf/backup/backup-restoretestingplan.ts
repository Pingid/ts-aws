...
export interface BackupRestoreTestingPlan extends ResourceAttributes {
  ...
  Properties: {
     ...
     * - _Required_: No
     * - _Type_: String
     * - _Allowed values_: `ACTIVE | SUSPENDED`
     * - _Update requires_: [No interruption](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-no-interrupt)
     *
     * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-backup-restoretestingplan.html#cfn-backup-restoretestingplan-schedulestatus */
    ScheduleStatus?: string | Intrinsic
    /**
