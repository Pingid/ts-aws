...
export interface TargetAddress {
     ...
     * - _Update requires_: [No interruption](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-no-interrupt)
     * 
     * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-route53resolver-resolverrule.html#cfn-route53resolver-resolverrule-targetaddress-servernameindication */
    "ServerNameIndication"?: string | Intrinsic;
}
...
export interface Route53ResolverResolverRule extends ResourceAttributes {
