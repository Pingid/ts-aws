...
export interface MulticastSourceSettings {
     ...
     * - _Update requires_: [No interruption](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-no-interrupt)
     * 
     * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-mediaconnect-bridge.html#cfn-mediaconnect-bridge-multicastsourcesettings-multicastsourceip */
...
export interface BridgeNetworkSource {
     ...
     * - The settings related to the multicast source.
     * - _Required_: No
     * - _Type_: [MulticastSourceSettings](./aws-properties-mediaconnect-bridge-multicastsourcesettings.html)
     * - _Update requires_: [No interruption](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-no-interrupt)
     * 
     * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-mediaconnect-bridge.html#cfn-mediaconnect-bridge-bridgenetworksource-multicastsourcesettings */
...
export interface MediaConnectBridge extends ResourceAttributes {
