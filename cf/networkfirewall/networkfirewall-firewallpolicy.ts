...
export interface FlowTimeouts {
     ...
     * - _Update requires_: [No interruption](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-no-interrupt)
     * 
     * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-networkfirewall-firewallpolicy.html#cfn-networkfirewall-firewallpolicy-flowtimeouts-tcpidletimeoutseconds */
    "TcpIdleTimeoutSeconds"?: number | Intrinsic;
}
...
export interface StatefulEngineOptions {
     ...
     * - _Required_: No
     * - _Type_: [FlowTimeouts](./aws-properties-networkfirewall-firewallpolicy-flowtimeouts.html)
     * - _Update requires_: [No interruption](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-no-interrupt)
     * 
     * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-networkfirewall-firewallpolicy.html#cfn-networkfirewall-firewallpolicy-statefulengineoptions-flowtimeouts */
