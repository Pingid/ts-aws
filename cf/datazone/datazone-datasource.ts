...
export interface SageMakerRunConfigurationInput {
     ...
     * - _Update requires_: [No interruption](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-no-interrupt)
     * 
     * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-datazone-datasource.html#cfn-datazone-datasource-sagemakerrunconfigurationinput-trackingassets */
    "TrackingAssets": Record<string, (any | Intrinsic)[]>;
}
...
export interface GlueRunConfigurationInput {
     ...
     * - _Update requires_: [No interruption](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-no-interrupt)
     * 
     * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-datazone-datasource.html#cfn-datazone-datasource-gluerunconfigurationinput-catalogname */
    "CatalogName"?: string | Intrinsic;
    /**
...
export interface DataSourceConfigurationInput {
     ...
     * - Property description not available.
     * - _Required_: No
     * - _Type_: [SageMakerRunConfigurationInput](./aws-properties-datazone-datasource-sagemakerrunconfigurationinput.html)
     * - _Update requires_: [No interruption](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-no-interrupt)
     * 
     * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-datazone-datasource.html#cfn-datazone-datasource-datasourceconfigurationinput-sagemakerrunconfiguration */
...
export interface DataZoneDataSource extends ResourceAttributes {
    ...
    "Properties": {
         ...
         * 
         * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-datazone-datasource.html#cfn-datazone-datasource-connectionidentifier */
        "ConnectionIdentifier"?: string | Intrinsic;
        /**
