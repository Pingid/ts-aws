...
export interface OutboundEmailConfig {
     ...
     * - _Update requires_: [No interruption](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-no-interrupt)
     * 
     * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-connect-queue.html#cfn-connect-queue-outboundemailconfig-outboundemailaddressid */
    "OutboundEmailAddressId"?: string | Intrinsic;
}
...
export interface ConnectQueue extends ResourceAttributes {
    ...
    "Properties": {
         ...
         * - _Required_: No
         * - _Type_: [OutboundEmailConfig](./aws-properties-connect-queue-outboundemailconfig.html)
         * - _Update requires_: [No interruption](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-no-interrupt)
         * 
         * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-connect-queue.html#cfn-connect-queue-outboundemailconfig */
