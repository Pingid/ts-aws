...
export interface CreateRule {
    /**
     * - The schedule, as a Cron expression. The schedule interval must be between 1 hour and 1 year. For more information, see the [Cron and rate expressions](https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-scheduled-rule-pattern.html) in the _Amazon EventBridge User Guide_.
     * - _Required_: No
     * - _Type_: String
     * - _Pattern_: `cron\([^\n]{11,100}\)`
     * - _Minimum_: `17`
