...
export interface TopicConfigOptions {
     ...
     * 
     * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-quicksight-topic.html#cfn-quicksight-topic-topicconfigoptions-qbusinessinsightsenabled */
    "QBusinessInsightsEnabled"?: boolean | Intrinsic;
}
...
export interface QuickSightTopic extends ResourceAttributes {
    ...
    "Properties": {
         ...
         * - Configuration options for a `Topic`.
         * - _Required_: No
         * - _Type_: [TopicConfigOptions](./aws-properties-quicksight-topic-topicconfigoptions.html)
         * - _Update requires_: [No interruption](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-no-interrupt)
         * 
         * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-quicksight-topic.html#cfn-quicksight-topic-configoptions */
         ...
         * - _Update requires_: [Replacement](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-replacement)
         * 
         * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-quicksight-topic.html#cfn-quicksight-topic-folderarns */
