...
export interface SSMDocument extends ResourceAttributes {
  ...
  Properties: {
     ...
     * - _Required_: No
     * - _Type_: String
     * - _Allowed values_: `ApplicationConfiguration | ApplicationConfigurationSchema | Automation | Automation.ChangeTemplate | ChangeCalendar | CloudFormation | Command | DeploymentStrategy | Package | Policy | ProblemAnalysis | ProblemAnalysisTemplate | Session`
