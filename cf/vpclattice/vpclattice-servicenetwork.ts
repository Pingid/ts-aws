...
export interface SharingConfig {
     ...
     * 
     * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-vpclattice-servicenetwork.html#cfn-vpclattice-servicenetwork-sharingconfig-enabled */
...
export interface VpcLatticeServiceNetwork extends ResourceAttributes {
    ...
    "Properties": {
         ...
         * - Specify if the service network should be enabled for sharing.
         * - _Required_: No
         * - _Type_: [SharingConfig](./aws-properties-vpclattice-servicenetwork-sharingconfig.html)
         * - _Update requires_: [No interruption](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-no-interrupt)
         * 
         * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-vpclattice-servicenetwork.html#cfn-vpclattice-servicenetwork-sharingconfig */
