...
export interface CloudFormationPublisher {
  ...
  Properties: {
     ...
     * - For more information, see [Registering your account to publish CloudFormation extensions](https://docs.aws.amazon.com/cloudformation-cli/latest/userguide/publish-extension.html#publish-extension-prereqs) in the _AWS CloudFormation Command Line Interface (CLI) User Guide_.
     * - _Required_: No
     * - _Type_: String
