...
export interface CloudFormationResourceVersion extends ResourceAttributes {
    ...
    "Properties": {
         ...
         * - For information on generating a schema handler package, see [Modeling resource types to use with AWS CloudFormation](https://docs.aws.amazon.com/cloudformation-cli/latest/userguide/resource-type-model.html) in the _AWS CloudFormation Command Line Interface (CLI) User Guide_.
         * - _Required_: Yes
         * - _Type_: String
         * - _Minimum_: `1`
         * - _Maximum_: `4096`
