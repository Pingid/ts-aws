...
export interface FSxLustreFileSystem {
     ...
     * - _Update requires_: [No interruption](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-no-interrupt)
     * 
     * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sagemaker-space.html#cfn-sagemaker-space-fsxlustrefilesystem-filesystemid */
    "FileSystemId": string | Intrinsic;
}
...
export interface CustomFileSystem {
     ...
     * - A custom file system in Amazon FSx for Lustre.
     * - _Required_: No
     * - _Type_: [FSxLustreFileSystem](./aws-properties-sagemaker-space-fsxlustrefilesystem.html)
     * - _Update requires_: [No interruption](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-no-interrupt)
     * 
     * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sagemaker-space.html#cfn-sagemaker-space-customfilesystem-fsxlustrefilesystem */
