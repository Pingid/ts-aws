...
export interface SageMakerApp extends ResourceAttributes {
    ...
    "Properties": {
         ...
         * 
         * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sagemaker-app.html#cfn-sagemaker-app-recoverymode */
        "RecoveryMode"?: boolean | Intrinsic;
        /**
