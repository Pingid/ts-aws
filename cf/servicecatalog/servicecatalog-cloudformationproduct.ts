...
export interface ProvisioningArtifactProperties {
   ...
   * - _Required_: No
   * - _Type_: String
   * - _Allowed values_: `CLOUD_FORMATION_TEMPLATE | MARKETPLACE_AMI | MARKETPLACE_CAR | TERRAFORM_OPEN_SOURCE | TERRAFORM_CLOUD | EXTERNAL`
   * - _Update requires_: [No interruption](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-no-interrupt)
   *
...
export interface ServiceCatalogCloudFormationProduct extends ResourceAttributes {
  ...
  Properties: {
     ...
     * - _Required_: No
     * - _Type_: String
     * - _Allowed values_: `CLOUD_FORMATION_TEMPLATE | MARKETPLACE | TERRAFORM_OPEN_SOURCE | TERRAFORM_CLOUD | EXTERNAL`
     * - _Update requires_: [No interruption](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-no-interrupt)
     *
