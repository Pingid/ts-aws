...
/**
 * The `Tag` property type specifies Property description not available. for an [AWS::DataSync::LocationFSxOpenZFS](./aws-resource-datasync-locationfsxopenzfs.html).
 * 
