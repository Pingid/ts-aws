...
/**
 * The `Tag` property type specifies Property description not available. for an [AWS::DataSync::LocationFSxWindows](./aws-resource-datasync-locationfsxwindows.html).
 * 
