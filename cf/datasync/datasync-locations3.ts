...
/**
 * The `Tag` property type specifies Property description not available. for an [AWS::DataSync::LocationS3](./aws-resource-datasync-locations3.html).
 * 
 * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-datasync-locations3.html */
 ...
 * For more information, see the [_AWS DataSync User Guide_](https://docs.aws.amazon.com/datasync/latest/userguide/create-s3-location.html).
 * 
 * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-datasync-locations3.html */
