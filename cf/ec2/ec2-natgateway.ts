...
export interface EC2NatGateway extends ResourceAttributes {
    ...
    "Properties": {
        ...
        /**
         * - Secondary EIP allocation IDs. For more information, see [Create a NAT gateway](https://docs.aws.amazon.com/vpc/latest/userguide/nat-gateway-working-with.html) in the _Amazon VPC User Guide_.
         * - _Required_: No
