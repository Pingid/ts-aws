...
export interface PerformanceFactorReferenceRequest {
     ...
     * - _Update requires_: [Replacement](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-replacement)
     * 
     * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-spotfleet.html#cfn-ec2-spotfleet-performancefactorreferencerequest-instancefamily */
...
export interface CpuPerformanceFactorRequest {
     ...
     * - _Required_: No
     * - _Type_: Array of [PerformanceFactorReferenceRequest](./aws-properties-ec2-spotfleet-performancefactorreferencerequest.html)
     * - _Update requires_: [Replacement](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-replacement)
     * 
     * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-spotfleet.html#cfn-ec2-spotfleet-cpuperformancefactorrequest-references */
...
export interface BaselinePerformanceFactorsRequest {
     ...
     * - The CPU performance to consider, using an instance family as the baseline reference.
     * - _Required_: No
     * - _Type_: [CpuPerformanceFactorRequest](./aws-properties-ec2-spotfleet-cpuperformancefactorrequest.html)
     * - _Update requires_: [Replacement](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-replacement)
     * 
     * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-spotfleet.html#cfn-ec2-spotfleet-baselineperformancefactorsrequest-cpu */
...
export interface InstanceRequirementsRequest {
     ...
     * - _Required_: No
     * - _Type_: [BaselinePerformanceFactorsRequest](./aws-properties-ec2-spotfleet-baselineperformancefactorsrequest.html)
     * - _Update requires_: [Replacement](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-replacement)
     * 
     * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-spotfleet.html#cfn-ec2-spotfleet-instancerequirementsrequest-baselineperformancefactors */
