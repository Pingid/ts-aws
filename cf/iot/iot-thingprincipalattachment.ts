...
export interface IoTThingPrincipalAttachment extends ResourceAttributes {
    ...
    "Properties": {
         ...
         * 
         * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iot-thingprincipalattachment.html#cfn-iot-thingprincipalattachment-thingprincipaltype */
        "ThingPrincipalType"?: string | Intrinsic;
    };
}